...
//  描述符原始数据
const static unsigned char lenovo_touch_pad_i2c_hid_description_raw_data[] =
{
    //  offset 0x0
    ...
    0x05, 0x01,        //     Usage Page (Generic Desktop Ctrls)
    0x15, 0x00,        //     Logical Minimum (0)
    0x26, 0x35, 0x10,  //     Logical Maximum (4149)
    0x75, 0x10,        //     Report Size (16)
    0x55, 0x0E,        //     Unit Exponent (-2)
    0x65, 0x13,        //     Unit (System: English Linear, Length: Centimeter)
    0x09, 0x30,        //     Usage (X)
    0x35, 0x00,        //     Physical Minimum (0)
    0x46, 0x13, 0x02,  //     Physical Maximum (531)
    0x95, 0x01,        //     Report Count (1)
    0x81, 0x02,        //     Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
    0x46, 0x3B, 0x01,  //     Physical Maximum (315)
    0x26, 0x63, 0x08,  //     Logical Maximum (2147)
    0x09, 0x31,        //     Usage (Y)
    0x81, 0x02,        //     Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
    0x05, 0x0D,        //     Usage Page (Digitizer)
    ...
    0x46, 0xD0, 0x07,  //     Physical Maximum (2000)
    0x65, 0x21,        //     Unit (System: SI Linear, Length: Radians)
    0x81, 0x02,        //     Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
    0xC0,              //   End Collection
    ...
    0x96, 0xE0, 0x02,  //   Report Count (736)
    0x75, 0x08,        //   Report Size (8)
    0xB1, 0x02,        //   Feature (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position,Non-volatile)
...
static int mt_probe(struct hid_device *hdev, const struct hid_device_id *id)
{
  ...
  //  在解析之前，检查匹配的设备，并替换描述符
  //  https://eleccelerator.com/usbdescreqparser/
  //  当为 Lenovo ThinkBook 14 G6+的触摸板
  if((hdev->vendor == 0x27C6) && 
     (hdev->product == 0x01E9)
    )
  { 
      //  提示找到
      printk(KERN_EMERG "Found %04X:%04X GXTP5100 Touchpad for Lenovo ThinkBook 14 G6+, REV:0x%X", hdev->vendor, hdev->product, hdev->version);
      printk(KERN_EMERG "Touchpad name: %s", hdev->name);
      printk(KERN_EMERG "Touchpad phys: %s", hdev->phys);

      //  dump原始的描述符
      //print_hex_dump(KERN_EMERG, "", DUMP_PREFIX_NONE, 32, 1, hdev->dev_rdesc, hdev->dev_rsize, false);

      //  开始覆盖
      printk(KERN_EMERG "Start overwriting HID descriptors....");
      memcpy(hdev->dev_rdesc, lenovo_touch_pad_i2c_hid_description_raw_data, sizeof(lenovo_touch_pad_i2c_hid_description_raw_data));
      hdev->dev_rsize = sizeof(lenovo_touch_pad_i2c_hid_description_raw_data);
      printk(KERN_EMERG "Overwriting HID descriptors OK!! by rainhenry@savelife-tech.com");
  }
